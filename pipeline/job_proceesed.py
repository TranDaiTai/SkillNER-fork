...
def run_full_skill_pipeline(
    ...
    if force_fetch or not raw_path.exists():
        print("\nBước 1: Fetch raw Jobs từ Emsi API...")
    ...
    print("\nBước 2: Process raw → jobs_processed.json...")
    ...
    print("\nBước 3: Tạo token_dist_job.json...")
    token_gen = TokenDistGenerator(input_dir="./skillNer/data")
    try:
        token_dist = token_gen.generate_from_file("jobs_processed.json")
        token_gen.save(token_dist, "token_dist_job.json")
    ...
    # Bước 4: Tạo relax DB
    print("\nBước 4: Tạo job_db_relax_20.json...")
