...
if __name__ == "__main__":
    runner = PipelineRunner(
        ...
        skills_endpoint="https://emsiservices.com/skills/versions/latest/skills",
        raw_file= "./skillNer/data/raw_skills.json",
        ...
        # Nếu muốn dùng version khác (ví dụ v2 hoặc v3):
        # skills_endpoint="https://emsiservices.com/skills/versions/v3/skills"
